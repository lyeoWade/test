...
$_.tool.copyArticle = function(copyStrTag) {
	const range = document.createRange();
    range.selectNode(document.getElementById(copyStrTag)); //复制的容器
...
// document.getElementById('copyBT').addEventListener('click', $_.tool.copyArticle, false);
// 
// 
// 去空格
